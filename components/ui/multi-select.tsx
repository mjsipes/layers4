...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 p-1 py-2 ring-1 ring-muted rounded-md bg-background",
        {
...
>(({ className, ...props }, ref) => {
  ...
  // Merge the forwarded ref with the internal inputRef
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "ml-2 bg-transparent outline-none placeholder:text-muted-foreground flex-1 min-w-0",
        className,
